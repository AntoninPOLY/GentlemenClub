...
.orange-pink {
    background: linear-gradient(115deg, #d4145a, #e26c1d);
}
.orange-yellow {
    background: linear-gradient(115deg, #e26c1d, rgba(234, 168, 60, 0.99));
}
.yellow-red {
    background: linear-gradient(115deg, rgba(234, 168, 60, 0.99), #d4145a);
}
